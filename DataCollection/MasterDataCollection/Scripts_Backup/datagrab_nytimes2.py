...
while (1):
    ...
    for key in keys:
        url = 'https://api.nytimes.com/svc/search/v2/articlesearch.json?api-key='+key+'&q=business&begin_date=20160701&end_date=20160930&fl=section_name%2Cweb_url%2Clead_paragraph&page='+str(count)
        ...
        if (breakflag):
            ...
            break;
        with open("Business_Data/Month7_9/"+str(count)+".json",'w+') as out_json:
